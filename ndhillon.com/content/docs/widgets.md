...
Widgets empower you to fully customize your site. They display as sections on the homepage or on widget pages. They can be enabled/disabled and configured as desired. The default theme has the following widgets available to use:
...
To add a widget manually, copy the relevant widget to your `content/home/` folder. 
