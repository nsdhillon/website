...
This is a brief guide to managing content with the Hugo framework. Content can include publications, projects, talks, news/blog articles, and widget pages. After you have read this guide about creating and managing content, you may also be interested to learn about [writing content with Markdown, LaTeX, and Shortcodes]({{< ref "docs/writing-markdown-latex.md" >}}).<!--more-->
...
So you would like to create a page which utilizes Hugo's widget system, similar to the homepage?
...
Install widgets into your `content/courses/` folder. To achieve this, widgets can be copied from your `content/home/` folder.
...
You can edit the title and add your own content, such as an introduction, by copying the following content `_index.md` files to the same structure within your `content/` folder:
